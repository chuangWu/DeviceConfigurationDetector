package com.lenovo.leos.deviceconfigurationdetector;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addDeviceInfo("android_id", Settings.Secure.getString(this.getContentResolver(), Settings.Secure.ANDROID_ID), true);
     ...
     * 检测屏幕的的 density 类型
     *
     * @param densityDpi 结果为 ldpi mdpi hdpi xhdpi xxhdpi xxxhdpi 中的一个
     * @return
     */
